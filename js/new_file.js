	    ...
	    series: [
	        {
	           ...
	           label: {
	            ...
	            data:[
	                {value:5, name:'90+'},
	                {value:14, name:'80~90',selected:true},
	                {value:12, name:'65~80'}
	            ]
	        }
	    ]
...
function linchar(){
	...
	option = {
	    ...
	    series: [{
	        type: 'line',
	        data:[20.73, 21.26, 25.98, 26.77, 31.14],
	        itemStyle : {
	            normal : {
	                lineStyle:{
	                    width:3,//折线宽度
...
function progress1char(){
	...
	var baifenbi = [0.9011, 0.9064, 0.9157, 0.9211, 0.9327];
	var grayBar = [1, 1, 1, 1, 1, ];
	var paiming = [ 5, 4, 3, 2, 1];
	var xingm = ['CQ', 'LN', 'ZJ', 'BJ', 'HN'];
	option = {
	    title: {
	        text: '2015',
	        left: '75%',
